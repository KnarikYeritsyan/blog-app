...
//        videos
        ...
        Route::get('/video/{id}', 'AdminController@show_video')->name('admin.video');
        Route::post('/video/{id}', 'CrudAdminController@edit_video')->name('admin.video');
        Route::get('/video-create', 'AdminController@video_create')->name('admin.video-create');
        Route::post('/video-create', 'CrudAdminController@post_create_video')->name('admin.video-create');
        Route::get('/video-delete/{id}', 'CrudAdminController@video_delete')->name('admin.video-delete');
//        webinar
        Route::get('/webinar', 'AdminController@webinar')->name('admin.webinar');
        Route::post('/webinar', 'CrudAdminController@edit_webinar')->name('admin.webinar');
//        sliders
