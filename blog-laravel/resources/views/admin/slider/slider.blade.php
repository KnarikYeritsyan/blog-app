            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                        ...
                        @endif
                    <h4 class="card-title mb-3">{{$slider->title}}</h4>
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <img src="{{$slider->image_name_resize}}" alt="{{$slider->title}}">
                            @endif
                        </div>
                        <div class="form-group row">
                            <label for="slug" class="col-sm-2 col-form-label">{{__('Slug')}}</label>
                            <div class="col-sm-10">
                                <input id="slug" name="slug" type="text" class="form-control" value="{{$slider->slug}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="status" id="status" class="form-control">
                                    <option <?php if($slider->status) echo 'selected' ?> value="1">{{__('Published')}}</option>
                                    <option <?php if(!$slider->status) echo 'selected' ?> value="0">{{__('Not Published')}}</option>
                                </select>
                            </div>
                        </div>
                        <input type="hidden" name="upd_id" value="{{$slider->id}}">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane" id="home-b2">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="title" name="title_ru" type="text" class="form-control" value="{{isset($slider->translations['title']['ru'])?$slider->translations['title']['ru']:''}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="description" class="col-sm-2 col-form-label">{{__('Description')}}</label>
                                    <div class="col-sm-10">
                                        <textarea id="description" name="description_ru" class="summernote form-control">{{isset($slider->translations['description']['ru'])?$slider->translations['description']['ru']:''}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane show" id="profile-b2">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="title_en" name="title_en" type="text" class="form-control" value="{{isset($slider->translations['title']['en'])?$slider->translations['title']['en']:''}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="description" class="col-sm-2 col-form-label">{{__('Description')}}</label>
                                    <div class="col-sm-10">
                                        <textarea id="description" name="description_en" class="summernote form-control">{{isset($slider->translations['description']['en'])?$slider->translations['description']['en']:''}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane active" id="settings-b2">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="title_am" name="title_am" type="text" class="form-control" value="{{isset($slider->translations['title']['am'])?$slider->translations['title']['am']:''}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="description" class="col-sm-2 col-form-label">{{__('Description')}}</label>
                                    <div class="col-sm-10">
                                        <textarea id="description" name="description_am" class="summernote form-control">{{isset($slider->translations['description']['am'])?$slider->translations['description']['am']:''}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
