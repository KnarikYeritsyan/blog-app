            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                        ...
                        @endif
                    <h4 class="card-title mb-3">{{__('New Video')}}</h4>
                    <form method="POST" action="" enctype="multipart/form-data">
                        @csrf
                        <input hidden id="url_type" name="url_type" value="facebook">
                        <input hidden id="url_link" name="link" value="">
                        <div class="form-group row">
                            <label for="video-link" class="col-sm-2 col-form-label">{{__('Video Link')}}</label>
                            <div class="col-sm-10">
                                <input id="video-link" name="name" type="text" class="form-control" value="{{ $name ?? old('name') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-10" id="video-frame">
                                <div id="fb_vid" style="max-height: 500px;display: none" class="fb-video" data-href="" data-show-text="false" data-width="auto"></div>
                                <iframe id="you_vid" style="display: none" width="727" height="409" src="" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"  allowfullscreen></iframe>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="settings-b2">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="title_am" name="title_am" type="text" class="form-control" value="{{ $title_am ?? old('title_am') }}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="content" class="col-sm-2 col-form-label">{{__('Content')}}</label>
...
/*        var tag = document.createElement('script');
        ...
        $("#video-link").keyup(function() {
          ...
          /*if(text.includes('https://youtu.be/',0) || text.includes('https://www.youtube.com/',0)){
            $("#fb_vid").hide();
            // $("#you_vid").show();
            // $("#you_vid").attr('src',text);
            createVideo(text)
          }*/
        // });
    </script>
