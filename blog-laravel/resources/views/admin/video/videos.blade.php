...
@section('breadcrumb')
    <ol class="breadcrumb mb-2">
        ...
        <li class="breadcrumb-item active">{{__('Videos')}}</li>
    </ol>
@endsection
@section('css')
@endsection
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover m-b-0">
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="{{route('admin.video',['locale'=>app()->getLocale(),'id'=>$video->id])}}"><button type="button" class="btn btn-secondary"><i class="ti-pencil-alt"></i></button></a>
                            <a onclick="return confirm('{{__('Are you sure?')}}')" href="{{route('admin.video-delete',['locale'=>app()->getLocale(),'id'=>$video->id])}}"><button type="button" class="btn btn-danger"><i class="ti-trash"></i></button></a>
                            </td>
                        </tr>
                        @endforeach
                        </tbody>
                    </table>
                    <?php echo e($videos->appends($_GET)->links()); ?>
                </div>
            </div>
        </div>
    </div>
