                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input id="price" name="price" step="0.01" type="number" class="form-control" value="{{$product->price}}">
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="settings-b2">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input id="name_am" name="name_am" type="text" class="form-control" value="{{isset($product->translations['name']['am'])?$product->translations['name']['am']:''}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="description" class="col-sm-2 col-form-label">{{__('Description')}}</label>
