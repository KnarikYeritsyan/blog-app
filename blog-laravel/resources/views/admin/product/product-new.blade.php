                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input id="price" name="price" type="number" class="form-control" step="0.01" value="{{ $price ?? old('price') }}">
                            </div>
                        </div>
                        {{--<div class="form-group row">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="settings-b2">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input id="name_am" name="name_am" type="text" class="form-control" value="{{ $name_am ?? old('name_am') }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="description" class="col-sm-2 col-form-label">{{__('Description')}}</label>
