        ...
        <div class="scroll-sidebar" data-sidebarbg="skin6">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{route('admin.webinar',app()->getLocale())}}"
                    aria-expanded="false"><i data-feather="film" class="feather-icon"></i><span
                    class="hide-menu">{{__('Webinar')}}</span></a>
                    </li>
                    ...
                    <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{{route('admin.sliders',app()->getLocale())}}"
                                                 aria-expanded="false"><i data-feather="image" class="feather-icon"></i><span
                                    class="hide-menu">{{__('Sliders')}}</span></a>
                    </li>
